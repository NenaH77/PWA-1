...
console.log('------ variables ----------');
    ...
    var nameExample, courseExample, monthExample;
    console.log('nameEx: ', nameExample+ ' /courseEx: ', courseExample+ ' /monthEx:', monthExample);

    //example 3: a mix of variables defined and not defined
    var spouse, status = 'married', anniversary;
    console.log('spouse: ', spouse+ ' /status:', status+ ' /anniversary:', anniversary);
...
console.log('------ strings ----------');
    ...
    var detectiveName = 'James Bond';
    console.log('Example 1: ', detectiveName);
    ...
    var testEscape = "I need some \"quotes\" to be here.";
    console.log('Example 3:', testEscape);

    //string w/ escape characters and mixed single/double quotes
    var testMix = 'Here\'s an example of mixed quotes and the escape characters for '+'"PWA1"';
    console.log('Example 4:', testMix);

    //this example shows that all the "phase" vars above were overwritten
    var num = 3;
    var overRide = 'He\'s in PWA1' + num;
    console.log('Example 5:', overRide);
...
console.log('------ numbers ----------');
    ...
    var num2 = 5;
    num1 += num2;
    console.log("num1: (notice its adding num1 += num2) ", num1);
    console.log("num2: (notice it is NOT adding num1 += num2) ", num2);
    ...
    num--;
    console.log("-- used after...counter--: ", num);
    ...
    //modulo example
    //modulo, returns the remainder of an equation ex. 32/10= 2
...
/*
    ...
    */
    ...
    if ("1" == 1) {
    console.log("'1' == 1, True"); //== does not look at datatype but only number
    };
    ...
    if ("1" === 1) {
    console.log("'1' === 1, False"); //=== looks at datatype and number
    };
...
if("b" > "c") {
    ...
    console.log("b is less than d");
    }else if ("b" < "e") {
    console.log("b is less than e");
    }else{
    ...
    ********************************************/
    var outside = "Cloudy";
    var feeling = (outside === 'Sunny' ? 'happy' : 'sad');
 ...
 /*
    ...
    */
    var weatherForFriday = "Cloudy";
    var moodForFriday = (weatherForFriday === "Sunny" ? "happy" : "sad");
    console.log("Mood For Friday: ", moodForFriday);
    ...
    ********************************************/
    ...
    console.log("Bob's New Mood: ", moodType);